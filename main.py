...
flags.DEFINE_integer('eval_interval', 20_000, 'Evaluation interval.')
flags.DEFINE_integer('save_interval', 1000000, 'Saving interval.')

flags.DEFINE_integer('eval_tasks', 3, 'Number of online steps.')
flags.DEFINE_float('eval_temperature', 0.0, 'Number of online steps.')
...
def main():
    ...
    env, eval_env, train_dataset, val_dataset = make_env_and_datasets(dataset_name=FLAGS.env_name, frame_stack=FLAGS.frame_stack)
